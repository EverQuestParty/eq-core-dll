...
bool InitOffsets()
{
    ...
    ppUdpConnection = (UdpConnection**)pinstUdpConnection;
...
UdpConnection **ppUdpConnection = 0;
...
INITIALIZE_EQGAME_OFFSET(pinstUdpConnection);
...
INITIALIZE_EQGAME_OFFSET(Player__SendReliableMessage);
